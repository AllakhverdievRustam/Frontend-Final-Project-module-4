...
const BodyAuth = () => {
  return (
    <div className="main-block row w-100">
      <div className="block-img col">
        <svg className="" width="376" height="376" viewBox="0 0 376 376" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="input-form col p-5">
        <form className="mt-5">
